      ...
      <main className="w-full max-w-[1024px] grid md:grid-cols-2 bg-white rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(108,59,255,0.12)] border border-[#EEEAFF] animate-fade-in relative z-10">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center bg-white">
          <div className="w-full max-w-sm mx-auto">
            ...
            {/* Authenticating Simulator Form */}
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1">
                <label className="text-xs font-semibold text-slate-600 px-1">Email or Username</label>
                <input
                  type="text"
                  value={username}
              ...
              {/* Demo Role Selection Panel */}
              <div className="space-y-1 bg-indigo-50/50 p-3 rounded-xl border border-indigo-100/30">
                <label className="text-[11px] font-bold text-indigo-900 tracking-wider uppercase">Select Role Context (Demo Mode):</label>
              ...
              <button
                type="submit"
                className="w-full h-14 purple-card-gradient text-white font-sans text-sm font-semibold rounded-xl shadow-lg shadow-indigo-600/25 active:scale-[0.98] transition-all flex items-center justify-center gap-2 shine-effect mt-6"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 h-12 rounded-xl border-2 border-slate-150 hover:bg-slate-50 transition-all text-xs font-semibold text-slate-700"
              >
                <span className="w-4 h-4 rounded-full bg-slate-900 text-white flex items-center justify-center font-bold text-[9px]">A</span>
                Apple
              </button>
            </div>
            ...
            <div className="mt-8 text-center">
              <button
                type="button"
                onClick={() => onLoginSuccess('instructor')}
